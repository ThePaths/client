import {
  GET_USER_PATHS_REQUEST,
  GET_USER_PATHS_SUCCESS,
  GET_USER_PATHS_ERROR,
  GET_CURRENT_PATHS_REQUEST,
  GET_CURRENT_PATHS_SUCCESS,
  GET_CURRENT_PATHS_ERROR,
  GET_SAVED_PATHS_REQUEST,
  GET_SAVED_PATHS_SUCCESS,
  GET_SAVED_PATHS_ERROR,
  GET_COMPLETED_PATHS_REQUEST,
  GET_COMPLETED_PATHS_SUCCESS,
  GET_COMPLETED_PATHS_ERROR,
  GET_PATH_OVERVIEW_REQUEST,
  GET_PATH_OVERVIEW_SUCCESS,
  GET_PATH_OVERVIEW_ERROR,
  GET_PATH_STATUS_REQUEST,
  GET_PATH_STATUS_SUCCESS,
  GET_PATH_STATUS_ERROR
...
import {
  ...
  UPDATE_USERS_SAVED_PATHS_ERROR,
...
import {
  DELETE_CURRENT_COURSE_REQUEST,
  DELETE_CURRENT_COURSE_SUCCESS,
  DELETE_CURRENT_COURSE_ERROR,
  DELETE_SAVED_COURSE_REQUEST,
  DELETE_SAVED_COURSE_SUCCESS,
  DELETE_SAVED_COURSE_ERROR,
