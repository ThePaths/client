...
//PUT
export const UPDATE_USERS_CURRENT_PATHS_REQUEST =
  "UPDATE_USERS_CURRENT_PATHS_REQUEST";
export const updateUsersCurrentPathsRequest = () => ({
  type: UPDATE_USERS_SAVED_PATHS_REQUEST
});

export const UPDATE_USERS_CURRENT_PATHS_SUCCESS =
  "UPDATE_USERS_CURRENT_PATHS_SUCCESS";
export const updateUsersCurrentPathsSuccess = () => ({
  type: UPDATE_USERS_CURRENT_PATHS_SUCCESS
});

export const UPDATE_USERS_CURRENT_PATHS_ERROR =
  "UPDATE_USERS_CURRENT_PATHS_ERROR";
...
//PUT
export const UPDATE_USERS_SAVED_PATHS_REQUEST =
  "UPDATE_USERS_SAVED_PATHS_REQUEST";
export const updateUsersSavedPathsRequest = () => ({
  type: UPDATE_USERS_SAVED_PATHS_REQUEST
});

export const UPDATE_USERS_SAVED_PATHS_SUCCESS =
  "UPDATE_USERS_SAVED_PATHS_SUCCESS";
...
//PUT
export const UPDATE_USER_LAST_VIDEO_INDEX_REQUEST =
  "UPDATE_USER_LAST_VIDEO_INDEX_REQUEST";
export const updateUsersLastVideoIndexRequest = () => ({
  type: UPDATE_USER_LAST_VIDEO_INDEX_REQUEST
});

export const UPDATE_USER_LAST_VIDEO_INDEX_SUCCESS =
  "UPDATE_USER_LAST_VIDEO_INDEX_SUCCESS";
export const updateUsersLastVideoIndexSuccess = index => ({
  type: UPDATE_USER_LAST_VIDEO_INDEX_SUCCESS,
  index
});

export const UPDATE_USER_LAST_VIDEO_INDEX_ERROR =
  "UPDATE_USER_LAST_VIDEO_INDEX_ERROR";
...
//PUT
export const UPDATE_USER_MARK_VIDEO_COMPLETED_REQUEST =
  "UPDATE_USER_MARK_VIDEO_COMPLETED_REQUEST";
export const updateUserMarkVideoCompletedRequest = () => ({
  type: UPDATE_USER_MARK_VIDEO_COMPLETED_REQUEST
});

export const UPDATE_USER_MARK_VIDEO_COMPLETED_SUCCESS =
  "UPDATE_USER_MARK_VIDEO_COMPLETED_SUCCESS";
export const updateUserMarkVideoCompletedSuccess = videos => ({
  type: UPDATE_USER_MARK_VIDEO_COMPLETED_SUCCESS,
  videos
});

export const UPDATE_USER_MARK_VIDEO_COMPLETED_ERROR =
  "UPDATE_USER_MARK_VIDEO_COMPLETED_ERROR";
...
//PUT
export const UPDATE_USER_COMPLETED_COURSE_REQUEST =
  "UPDATE_USER_COMPLETED_COURSE_REQUEST";
export const upadateUserCompletedCourseRequest = () => ({
  type: UPDATE_USER_COMPLETED_COURSE_REQUEST
});

export const UPDATE_USER_COMPLETED_COURSE_SUCCESS =
  "UPDATE_USER_COMPLETED_COURSE_SUCCESS";
export const updateUserCompletedCourseSuccess = () => ({
  type: UPDATE_USER_COMPLETED_COURSE_SUCCESS
});

export const UPDATE_USER_COMPLETED_COURSE_ERROR =
  "UPDATE_USER_COMPLETED_COURSE_ERROR";
...
export const userCompletedVideo = (pathId, videoIndex) => (
  dispatch,
  getState
) => {
  const authToken = getState().auth.authToken;
